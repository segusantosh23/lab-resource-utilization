...
const DepartmentHeadDashboard = () => {
  ...
  const dashboardItems = [
    ...
    { 
      ...
      desc: "Track how effectively your lab's booking system is being used.", 
    ...
    { 
      ...
      desc: "Keep track of upcoming maintenance and repairs for your equipment.", 
    ...
    { 
      ...
      path: "/bookings?tab=all&status=PENDING_APPROVAL"
    }
  ];
