  ...
  return (
    <div className="min-h-screen bg-[#0d0e12] text-white font-sans pb-16 relative">
      ...
      <main className="max-w-7xl mx-auto px-6 mt-8 relative z-10 animate-fadeIn">
        <h1 className="text-3xl font-bold mb-8 tracking-tight">Lab Management Overview</h1>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-[#12131a] border border-white/[0.05] rounded-2xl p-5 shadow-lg">
            <p className="text-gray-400 text-sm font-medium mb-1">In Maintenance</p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-[#12131a] border border-white/[0.05] rounded-2xl p-6 shadow-xl transition hover:border-purple-500/30">
            <h3 className="text-lg font-semibold mb-2">Booking Approvals</h3>
            <p className="text-gray-400 text-sm mb-4">Review and manage pending reservation requests.</p>
          ...
          <div className="bg-[#12131a] border border-white/[0.05] rounded-2xl p-6 shadow-xl transition hover:border-purple-500/30">
            <h3 className="text-lg font-semibold mb-2">Department Utilization Heatmap</h3>
            <p className="text-gray-400 text-sm mb-4">Analyze peak usage patterns and idle times.</p>
            <div className="h-32 flex items-center justify-center border border-dashed border-white/[0.1] rounded-lg text-gray-500 text-sm"></div>
          </div>
        </div>
      </main>
